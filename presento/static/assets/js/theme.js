...
var theme = {
  ...
  */
  ...
  //   }
  // },
      if (document.querySelector(".rotator-fade-1") != null) {
        var replaceFade1 = new ReplaceMe(document.querySelector('.rotator-fade-1'), {
          animation: 'animate__animated animate__fadeInDown',
          speed: 2500,
          separator: ',',
          clickChange: false,
      ...
      // Initialize the second rotator-fade (To Video, To MP4)
      if (document.querySelector(".rotator-fade-2") != null) {
        var replaceFade2 = new ReplaceMe(document.querySelector('.rotator-fade-2'), {
          animation: 'animate__animated animate__fadeInDown',
          speed: 2500,
          separator: ',',
          clickChange: false,
